<?php
    ...
    $product_meta = $car->FindById($product_id_get);
    $megas = $category->FindAllMegaCategory();
...
<head>
    ...
    <title><?=$settings['SiteName']?> | <?=$product_meta['CarName']?></title>
    <meta name="description" content="<?=$product_meta['CarMetaDescription']?>">
...
<!-- Main Wrapper Start -->
    <div class="home_black_version">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcrumb_content">
                            <h3><?=$product_meta['CarName']?></h3>
                            <ul>
                                <li><a href="<?=APP_HOME?>">home</a></li>
                                <li>></li>
                                <li><a href="<?=APP_HOME?>/cars">cars</a></li>
                                <li>></li>
                                <li>car details</li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="product_d_right">
                                <h1><?=$product_meta['CarName']?></h1>
                                <div class="product_nav">
                                        <?php 
                                            $seq = $product_meta['CarSequence'];
                                        ?>
                                    <ul>
                                        <li class="prev"><a href="car.php?item=<?=$car->FindIdBySequence($seq)?>"><i class="fa fa-angle-left"></i></a></li>
                                        <li class="next"><a href="car.php?item=<?=$car->FindIdBySequence($seq, 1)?>"><i class="fa fa-angle-right"></i></a></li>
                                    </ul>
                                </div>
                                <div class=" product_ratting">
                                    <ul>
                                        <?=$util->ShowRating($car->FindProductRate($product_id_get))?>
                                        <li><a href="#"> ( customer rating ) </a></li>
                                    </ul>
                                </div>
                                <div class="product_price">
                                    <?php if($product_meta['CarDiscountValue'] > 0){?>
                                        <span class="old_price"><?=$_SESSION['cry'] .' ' .$util->Forex($product_meta['CarPrice'])?></span>
                                    <?php } ?>
                                        <span class="current_price"><?=$_SESSION['cry'] .' ' .$util->Forex($util->ApplyDiscountCar($product_meta))?></span>
                                </div>
                                <div class="product_desc">
                                    <p><?=$util->Slice($product_meta['CarMetaDescription'], 500)?></p>
                                </div>
                                <!-- packs -->
                                ...
                                <ul style="list-style: cambodian;margin-left:3%;margin-bottom:3%;">
                                    <?php
                                        $car_packs = explode(',', $product_meta['CarPacks']);
                                ...
                                <?php
                                    if(isset($_POST['reserver_pay']) && !empty($_POST['pickup'])){
                                        $pickup = $_POST['pickup'];
                                        $fromdate = date_create($_POST['fromdate']);
                                        $tilldate = date_create($_POST['tilldate']);
                                        $car_id = $_POST['CarId'];
                                        $now = date_create();
                                        if($fromdate < $now ){
                                            print '<span style="font-size: 30px;" class="alert alert-danger">From date is invalid!</span><br><br><br>';
                                        }elseif($tilldate <= $fromdate ){
                                            ...
                                            $reservation_data = [
                                                ...
                                                'to' => $_POST['tilldate'],
                                                'car' => $car_id,
                                                'order' => 'CH'.$util->KeyGen(6,1)
                                            ];
                                            $_SESSION['car_order'] = $reservation_data;
                                            $util->RedirectTo(APP_HOME.'/cars/pay.php');
                                        }
                                    }
                                ?>
                                ...
                                <!-- end packs -->
                                        <!-- form -->
                                    <?=$util->CarBookingForm($product_id_get, 'hr_')?>
                                    <!-- end form -->
                                </form>
                                ...
                                <div class="product_meta">
                                    <a style="font-size: 11px;font-weight: 100;" href="cars.php?htl=<?=$product_meta['CarOwner']?>"><?=$user->FindById($product_meta['CarOwner'])['UserFullName']?></a>
                                </div>
        ...
        <!-- area end-->
        <?php
            $ratings = $car->FindRatings($product_id_get);
                        ...
                        <div class="product_d_inner">   
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="info" role="tabpanel" >
                                    ...
                                    <?=$util->RemoveStyle($util->HtmlDecode($product_meta['CarDescription']))?>
                                    </div>    
                                </div>

                                <div class="tab-pane fade" id="reviews" role="tabpanel" >
                                    <div class="reviews_wrapper">
                                        <h4 style="color:#faa618;"><?=$count_r?> <?=$rlabel?> for <?=$product_meta['CarName']?></h4><br>
                                        <?php 
        ...
        <!-- area end--> 
        <?php 
            $related_items_on_item = $car->FindByVendor($product_meta['CarOwner']);
            ...
            <div class="container">
                ...
                <div class="col-12">
                        <div class="section_title">
                            <h2>More deals from <?=$user->FindById($product_meta['CarOwner'])['UserFullName']?></h2>
                        </div> 
                    </div>  
                    <div class="col-12">
                            ...
                            <div class="product_container bottom">
                                <div class="custom-row product_row1">
                                    ...
                                    foreach( $related_items_on_item as $riot ):
                                        if($car->isReady($riot['CarId'])){
                                    ?>
                                    <div class="custom-col-5">
                                        <div class="single_product">
                                            <div class="product_thumb">
                                                <a class="primary_img" href="car.php?item=<?=$riot['CarId']?>"><img src="<?=APP_IMG_PATH?>items/<?=$gallery->FindByTypeProduct($riot['CarId'],'5003')['GalleryPath']?>" alt=""></a>
                                                <a class="secondary_img" href="car.php?item=<?=$riot['CarId']?>"><img src="<?=APP_IMG_PATH?>items/<?=$gallery->FindByTypeProduct($riot['CarId'],'5005')['GalleryPath']?>" alt=""></a>
                                                <div class="quick_button">
                                                    <a href="car.php?item=<?=$riot['CarId']?>" data-placement="top" data-original-title="quick view"> quick view</a>
                                                </div>
                                            </div>
                                            <div class="product_content">
                                                <h3><a href="car.php?item=<?=$riot['CarId']?>"><?=$riot['CarName']?></a></h3>
                                                <?php if($riot['CarDiscountValue'] > 0){?>
                                                    <!-- <span class="old_price"><=$_SESSION['cry'] .' ' .$util->Forex($riot['CarPrice'])?></span> -->
                                                <?php } ?>
                                                <span class="current_price" style="color: #faa618;"><?=$_SESSION['cry'] .' ' .$util->Forex($util->ApplyDiscountCar($riot))?></span>
                                                <div class="product_hover">
                                                    <div class="product_ratings">
                                                        <ul>
                                                        <?=$util->ShowRating($car->FindProductRate($riot['CarId']))?>
                                                        </ul>
                                                    </div>
                                                    <div class="product_desc">
                                                        <p><?=$util->Slice($riot['CarMetaDescription'], 80)?></p>
                                                    </div>
                                                    <div class="action_links">
                                                        <form action="" name="st_<?=$riot['CarId']?>" method="post">
                                                        <ul>
                                                            <li><a href="car.php?item=<?=$riot['CarId']?>" title="Wishlist"><span class="icon icon-Heart"></span></a></li>
                                                            <a href="car.php?item=<?=$riot['CarId']?>" data-placement="top" data-original-title="c mo"> See more</a>
                                                            <li><a onclick="StarProduct('<?=$riot['CarId']?>',3)" title="Star"><i class="ion-ios-star-outline"></i></a></li>
                                                        </ul>
                                                        </form>
                                                    </div>
                                                </div>
