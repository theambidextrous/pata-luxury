...
$roomcategory = new RoomCategory($util->CreateConnection());
...
<html>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        switch($_REQUEST['action']){
                            default:
                                require_once 'inc/hotel_landing.php';
                            break;
                            case 'mrchnt-details':
                                require_once 'inc/hotel_manager.php';
                            break;
                        }
                        ?>
                        <!-- short cuts -->
    ...
    jQuery(document).ready(function(){
            ...
            $.ajax({
                ...
                success: function(res){
                    ...
                    if(rtn.hasOwnProperty("MSG")){
                        ...
                        $('#stocks').html(rtn.data.tab4);
                        $('#Room_manager_btn').trigger('click');
                        waitingDialog.hide()
                    }
                },
                error: function(xhr, status, err){
        ...
        // create
        updateRoom = function(formid){
            tinymce.triggerSave();
            waitingDialog.show('Updating database... Please wait',{headerText:'PataShop Notifications',headerSize: 6,dialogSize:'sm'});
            var data = new FormData($('#' + formid)[0]);
            $.ajax({
                type: 'post',
                url: '<?=APP_AJAX_RT?>?activity=update-Room-item',
                data: data,
                processData: false,
                contentType: false,
                cache: false,
...
<!-- Create room modal -->
<div class="modal fade" id="room_create">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="padding-bottom: 0px;">
                <a href="#" data-dismiss="modal" class="class pull-right"><span class="glyphicon glyphicon-remove"></span></a>
                <h4 class="m-t-0 header-title"><b>Create New Room</b></h4>
            </div>
            <!-- m-body -->
            <form method="post" id="create_Room_form" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12">
                            <div class="card-box">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <input type="text" value="" class="form-control" id="RoomName" name="RoomName" placeholder="Room name">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <input type="number" min="1" value="" class="form-control" id="RoomPrice" name="RoomPrice" placeholder="Price">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end row -->
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <select class="form-control select2" name="RoomCommisionType" id="RoomCommisionType">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <input type="text" value="" class="form-control" id="RoomCommisionValue" name="RoomCommisionValue" placeholder="Commission Value">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end row -->
                                    ...
                                    <div class="col-lg-4">  
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <select class="form-control select2" name="RoomDiscountType" id="RoomDiscountType">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <input type="text" value="" class="form-control" id="RoomDiscountValue" name="RoomDiscountValue" placeholder="Discount Value">
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group m-b-20">
                                                    <input type="number" value="" class="form-control" id="Room3D" name="Room3D" placeholder="3D Spinzam">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group m-b-20">
                                                    <input type="text" value="" class="form-control" id="RoomMetaDescription" name="RoomMetaDescription" placeholder="Meta Description">
                                                </div>
                                                <div class="form-group m-b-20">
                                                    <select class="form-control select2" name="RoomOwner" id="RoomOwner">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group m-b-20">
                                            <label>Room Classification<span class="text-danger">*</span></label>
                                            <select class="form-control select2" name="RoomCategory" id="RoomCategory" data-placeholder="Room Classification">
                                                <?php 
                                                foreach( $roomcategories as $rc ):
                                                    print '<option value="'.$rc['RoomCategoryId'].'">'.$rc['RoomCategoryName'].'</option>';
                                                endforeach;
                                                ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group m-b-20">
                                            <select class="form-control select2" name="RoomPacks[]" id="RoomPacks" multiple="multiple" data-placeholder="Select Room Packs">
                                                <?php 
                                                foreach( $packs as $pk ):
                                        ...
                                        <div class="form-group m-b-20">
                                            <input type="text" value="" class="form-control" id="RoomShortDescription" name="RoomShortDescription" placeholder="Short Description">
                                        </div>
                                        <div class="form-group m-b-20">
                                            <button type="button" name="save-Room" onclick="postRoom('create_Room_form')" class="btn w-sm btn-default waves-effect waves-light">Create item</button>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group m-b-20">
                                            <label>Room Description<span class="text-danger">*</span></label>
...
<!-- manage item modal -->
<a href="#" data-backdrop="static" data-keyboard="false" data-toggle="modal" id="Room_manager_btn" style="display:none;" data-target="#manage_item"></a>
                        ...
                        <div class="panel with-nav-tabs panel-primary">
                            <div class="panel-heading">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#updateitem" data-toggle="tab">Update Room</a></li>
                                    <li><a href="#galleries" data-toggle="tab">Room Gallery</a></li>
                                    <li><a href="#sizes" data-toggle="tab">Room Sizes</a></li>
                                    <!-- <li><a href="#params" data-toggle="tab">Room Measurements</a></li> -->
