...
<div class="row">
    <div class="col-sm-12">
        <h4 class="page-title">Service Users</h4>
...
<div class="row">
    ...
    ?>
    <div class="col-sm-12">
        <div class="Holidayd-box table-responsive">
            <h4 class="m-t-0 header-title"><b>Holiday Packages & Concierge</b></h4>
            <p class="text-muted font-13 m-b-30">
                Manage PataShop Holiday Packages & Concierge services.
            </p>
            ...
            <table id="datatable-buttons" class="table table-striped table-bordered">
                ...
                foreach($merchants as $merch): ?>
                    <tr>
                        ...
                        <td><a href="?action=mrchnt-details&usr-curr=<?=$merch['UserId']?>" class="btn btn-outline"><span class="md md-pageview"> </span> View Packages</a></td>
