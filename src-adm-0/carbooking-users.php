...
<html>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        switch($_REQUEST['action']){
                            default:
                                require_once 'inc/car_landing.php';
                            break;
                            case 'mrchnt-details':
                                require_once 'inc/car_manager.php';
                            break;
                        }
                        ?>
                        <!-- short cuts -->
    ...
    jQuery(document).ready(function(){
        ...
        //details
        CarDetailsModal = function(CarId){
            ...
            $.ajax({
                type: 'post',
                url: '<?=APP_AJAX_RT?>?activity=show-car-modal',
                data: data,
                success: function(res){
                    // console.log(res);
                    rtn = JSON.parse(res);
        ...
        // create
        updateCar = function(formid){
            tinymce.triggerSave();
            waitingDialog.show('Updating car info... Please wait',{headerText:'PataShop Notifications',headerSize: 6,dialogSize:'sm'});
            var data = new FormData($('#' + formid)[0]);
            $.ajax({
                type: 'post',
                url: '<?=APP_AJAX_RT?>?activity=update-car-item',
                data: data,
                processData: false,
                contentType: false,
                cache: false,
...
<!-- Create car modal -->
<div class="modal fade" id="Car_create">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="padding-bottom: 0px;">
                <a href="#" data-dismiss="modal" class="class pull-right"><span class="glyphicon glyphicon-remove"></span></a>
                <h4 class="m-t-0 header-title"><b>Create New Car</b></h4>
            </div>
            <!-- m-body -->
                            ...
                            <div class="card-box">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <input type="text" value="" class="form-control" id="CarName" name="CarName" placeholder="Car name">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <input type="text" value="" class="form-control" id="CarPlateNumber" name="CarPlateNumber" placeholder="Car License Plate Number">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end row -->
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <input type="text" value="" class="form-control" id="CarPrice" name="CarPrice" placeholder="Car Hire/Rent Price">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <input type="text" value="" class="form-control" id="CarBrand" name="CarBrand" placeholder="CarBrand">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end row -->
                                    ...
                                    <div class="col-lg-8">  
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <input type="text" value="" class="form-control" id="CarCommisionValue" name="CarCommisionValue" placeholder="Commission Value">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <input type="number" value="" class="form-control" id="Car3D" name="Car3D" placeholder="3D Spinzam">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group m-b-20">
                                                    <input type="text" value="" class="form-control" id="CarMetaDescription" name="CarMetaDescription" placeholder="Meta Description">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group m-b-20">
                                            <input type="text" value="" class="form-control" id="CarDiscountValue" name="CarDiscountValue" placeholder="Discount Value">
                                        </div>
                                        ...
                                        <div class="form-group m-b-20">
                                            <button type="button" name="save-Car" onclick="postCar('create_Car_form')" class="btn w-sm btn-default waves-effect waves-light">Create item</button>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group m-b-20">
                                            <label>Car Description<span class="text-danger">*</span></label>
                                            <textarea class="form-control" id="CarDescription" name="CarDescription"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- manage item modal -->
<a href="#" data-backdrop="static" data-keyboard="false" data-toggle="modal" id="Car_manager_btn" style="display:none;" data-target="#manage_item"></a>
                        ...
                        <div class="panel with-nav-tabs panel-primary">
                            <div class="panel-heading">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#updateitem" data-toggle="tab">Update Car</a></li>
                                    <li><a href="#galleries" data-toggle="tab">Car Gallery</a></li>
                                    <li><a href="#booking" data-toggle="tab">Car Bookings</a></li>
                                </ul>
                            </div>
